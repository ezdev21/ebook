    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <header class="font-semibold bg-gray-100 text-first text-center py-3 sm:py-3 sm:rounded-t-md text-2xl">
                    Register to our liberary
                </header>
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="text-xl w-full text-xs text-center text-gray-700 my-6 sm:my-8">
                            {{ __('Already have an account?') }}
                            <a class="text-first hover:text-blue-700 no-underline hover:underline" href="{{ route('login') }}">
                                {{ __('Login') }}
                            </a>
                        </p>
                    </div>

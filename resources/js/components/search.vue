<template>
 <div class="rounded-lt-4xl rounded-rb-4xl p-5 bg-pink-600">
   <form @submit.prevent="search" class="flex">
    ...
    <input type="text" v-model="query" required class="text-first w-96 py-2.5 px-3 text-lg lg:text-xl xl:text-xl 2xl:text-xl outline-none focus:border-b-2 border-tiruhakim" placeholder="search catalog">

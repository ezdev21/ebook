<template>
 <div class="rounded-lt-4xl rounded-rb-4xl p-3">
   ...
   <form @submit.prevent="search" method="POST" class="flex items-center">
     ...
     <select v-model="searchType" class="text-gray-700 p-2.5 text-xl border-r-2 border-first">
     ...
     <select v-model="searchBy" class="text-gray-700 p-2.5 text-xl border-r-2 border-first">
     ...
     <input type="text" v-model="query" required class="text-second w-96 py-2.5 px-3 text-lg lg:text-xl outline-none focus:border-b-2 border-second" placeholder="search...">
     <button type="submit" class="bg-second capitalize rounded-r-3xl lg:rounded-r-3xl text-xl lg:text-3xl py-2.5 px-5 my-auto">
